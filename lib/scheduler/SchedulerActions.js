...
var _SerialSubscription3 = babelHelpers.interopRequireDefault(_SerialSubscription2);

var _utilImmediate = require('../util/Immediate');

var _utilImmediate2 = babelHelpers.interopRequireDefault(_utilImmediate);
...
var ScheduledAction = (function (_SerialSubscription) {
    function ScheduledAction(scheduler, state, work) {
        babelHelpers.classCallCheck(this, ScheduledAction);
    ...
    babelHelpers.inherits(ScheduledAction, _SerialSubscription);
...
var NextScheduledAction = (function (_ScheduledAction) {
    function NextScheduledAction() {
        babelHelpers.classCallCheck(this, NextScheduledAction);
    ...
    babelHelpers.inherits(NextScheduledAction, _ScheduledAction);
...
var FutureScheduledAction = (function (_ScheduledAction2) {
    function FutureScheduledAction(scheduler, state, work, delay) {
        babelHelpers.classCallCheck(this, FutureScheduledAction);

        _ScheduledAction2.call(this, scheduler, state, work);
        this.delay = delay;
    }

    babelHelpers.inherits(FutureScheduledAction, _ScheduledAction2);
...
//# sourceMappingURL=SchedulerActions.js.map