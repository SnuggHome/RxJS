...
var IntervalObservable = (function (_Observable) {
    function IntervalObservable(interval, scheduler) {
        babelHelpers.classCallCheck(this, IntervalObservable);
    ...
    babelHelpers.inherits(IntervalObservable, _Observable);
...
var IntervalObserver = (function (_Observer) {
    function IntervalObserver(destination, interval, scheduler) {
        babelHelpers.classCallCheck(this, IntervalObserver);
    ...
    babelHelpers.inherits(IntervalObserver, _Observer);
